...
import com.kowalski.api.department.model.Department;
import com.kowalski.api.department.repository.DepartmentRepository;
...
public class DepartmentServiceApplication {
	...
	public Docket swaggerPersonApi10() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.kowalski.api.department.controller"))
